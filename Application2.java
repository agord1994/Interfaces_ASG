...
* In this class two tasks are instantiated and compared priority levels based on interface Priority. The same is done for two Process objects
*Status enum is also implemented and assigned to Task object.
*
